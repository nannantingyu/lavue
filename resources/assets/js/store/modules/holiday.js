...
const state = {
    columns: {
        ...
        market: {title: "交易市场", show: true},
        holiday_name: {title: "假期名称", show: true},
        detail: {title: "详情", show: true},
...
const actions = {
    add_update:({commit, state},form) => {
        return new Promise((resolve, reject) => {
            axios.post('/api/holiday/add',form).then(result=> {
